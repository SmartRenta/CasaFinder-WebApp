    ...
    <div className="p-8 bg-gray-100">
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="lg:w-1/2 w-full">
          ...
          {/* Presentación mejorada de la información principal */}
          ...
          {/* Carrusel ajustado para que sea más alto */}
          <div className="mt-4">
            <Carousel
              ...
              autoPlaySpeed={3000}
              centerMode={false}
              className="h-96"  // Ajustamos la altura a 96 unidades
            ...
            >
              {property.images.map((image, index) => (
                <img
                  ...
                  className="w-full h-96 object-cover rounded-lg" // Ajustamos la altura a 96 unidades
                />
              ))}
            </Carousel>
          </div>
