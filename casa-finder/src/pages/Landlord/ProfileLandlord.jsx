        ...
        <div className="profile-container">
            <header className="profile-header">
                <div className="profile-picture-wrapper">
                    ...
                    <span className="edit-icon" onClick={handleEditTogglePicture}>✎</span>
                </div>
            ...
            <div className="profile-main">
                ...
                <section className="profile-section">
                    <h3>Descripción <span className="edit-icon cursor-pointer float-right"
                ...
                <section className="profile-contact">
                    <h3>Contacto <span className="edit-icon cursor-pointer float-right"
